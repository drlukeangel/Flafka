...
| 2026-03-01 | Phase 12.5 Phase 2: Contextual Help Cleanup + Phase 12.5 Partial Impl | Closer | 0a6b7b0 | onOpenHelp prop removed (EditorCell, HistoryPanel, ResultsTable, App.tsx), inline error banners (SchemaList, TopicList), health score red/yellow/green logic refined, Schema Registry env guard (SchemaPanel), clearSchemaRegistryError action, AbortController test coverage. 1653 tests (100% pass). |
