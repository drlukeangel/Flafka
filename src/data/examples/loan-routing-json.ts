...
-- ============================================================`,
  ...
  completionModal: {
    ...
    steps: [
      { label: 'Start the routing engine', detail: 'Run the routing-engine cell \u2014 temporal join + CROSS JOIN UNNEST fans each event to all its target topics. Consumers can start before or after.' },
